...
Spaces are customisable, community-managed sub-portals within HEP Training, each with their own catalogue of training content. 
...
To request a new space on HEP Training:

1. Select a HEP Training instance with multiple spaces for your request.
