...
![Logo for TeSSHub4EOSC](../images/overview/tesshub4eosc-logo.png)

## About TeSSHub4EOSC

The **TeSSHub4EOSC** project will establish a distributed, FAIR-compliant catalog infrastructure for training materials and events within the European Open Science Cloud (EOSC), based on the [mTeSS-X platform](mtess-x) (originally developed in the OSCARS Open Science project). This system will integrate decentralised training resource catalogues, serving as a central backbone for the EOSC Catalogue.
